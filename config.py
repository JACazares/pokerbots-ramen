...
PLAYER_1_NAME = 'A'
PLAYER_1_PATH = './ramen-2 (scrimmage)'
# NO TRAILING SLASHES ARE ALLOWED IN PATHS
PLAYER_2_NAME = 'B'
PLAYER_2_PATH = './ramen-2'
...
NUM_ROUNDS = 1000       #1000 default
STARTING_STACK = 400    #400 default
BIG_BLIND = 2           #2 default
SMALL_BLIND = 1         #1 default
